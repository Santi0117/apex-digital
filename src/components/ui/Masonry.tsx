...
const useMeasure = (): [RefObject<HTMLDivElement | null>, Size] => {
...
export default function Masonry({
  ...
  const getInitialPosition = (item: GridItem) => {
    ...
    let direction: AnimateFrom | string = animateFrom;
            ...
            {colorShiftOnHover && (
              <div
                ...
                style={{
                  ...
                  height: "100%",
                  background:
                    "linear-gradient(45deg, rgba(8,145,178,0.45), rgba(14,116,144,0.35))",
                  opacity: 0,
                  pointerEvents: "none",
                  borderRadius: "12px",
                }}
